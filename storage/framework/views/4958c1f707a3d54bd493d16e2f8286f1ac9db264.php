...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <?php endif; ?>
      <a href="<?php echo e(route('product.create', ['estate_type_id' => $arrSearch['estate_type_id'], 'type' => $arrSearch['type'], 'city_id' => $arrSearch['city_id']])); ?>" class="btn btn-info btn-sm" style="margin-bottom:5px">Tạo mới</a>
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form class="form-inline" id="searchForm" role="form" method="GET" action="<?php echo e(route('product.index')); ?>">                        
              ...
              <select class="form-control" name="city_id" id="city_id">
                <option value="">--Tỉnh/TP--</option>
                  <?php foreach( $cityList as $value ): ?>
                    <option value="<?php echo e($value->id); ?>"
                    <?php echo e($arrSearch['city_id'] == $value->id ? "selected" : ""); ?>                        
            ...
            <div class="form-group">              
              <input type="text" placeholder="Mã tin" class="form-control" name="id" value="<?php echo e($arrSearch['id']); ?>" style="width:80px">
            </div>           
