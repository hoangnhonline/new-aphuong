...
<div class="collapse navbar-collapse menu" id="bs-example-navbar-collapse-1">
    ...
    <ul class="nav navbar-nav navbar-left">
        ...
        <?php foreach($menuList as $value): ?>
            <?php if($value->type == 1): ?>
                <li class="level0 <?php echo e((isset($cateDetail) && $cateDetail->id == $value->object_id) ? "active" : ""); ?>"><a href="<?php echo e(route('news-list', $value->slug)); ?>"><?php echo $value->title; ?></a></li>
            <?php elseif($value->type == 2): ?>
                <li class="level0 <?php echo e((isset($detailPage) && $detailPage->id == $value->object_id) ? "active" : ""); ?>"><a href="<?php echo e(route('danh-muc', $value->slug)); ?>"><?php echo $value->title; ?></a></li>
            <?php elseif($value->type == 3): ?>
                <li class="level0"><a href="<?php echo e($value->url); ?>"><?php echo $value->title; ?></a></li>
            <?php endif; ?>
