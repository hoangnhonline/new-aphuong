...
<div class="container">
	...
	<div class="block block-title">		  
		<ul class="nav nav-tabs nav-tabs-langding" id="nav-tabs-langding" role="tablist">
			...
			<li role="presentation" @if($tab_id == 1) class="active" @endif>
				<a href="#{{ (isset($articlesDetail[1])) ?  $articlesDetail[1]->slug : "" }}" >
					<i class="icon">
		    ...
		    <li role="presentation" @if($tab_id == 2) class="active" @endif>
		    	<a href="#{{ (isset($articlesDetail[2])) ?  $articlesDetail[2]->slug : "" }}" >
		    		<i class="icon">
		    ...
		    <li role="presentation" @if($tab_id == 3) class="active" @endif>
		    	<a href="#{{ (isset($articlesDetail[3])) ?  $articlesDetail[3]->slug : "" }}" >
		    		<i class="icon">
		    ...
		    <li role="presentation" @if($tab_id == 4) class="active" @endif>
		    	<a href="#{{ (isset($articlesDetail[4])) ?  $articlesDetail[4]->slug : "" }}" >
		    		<i class="icon">
		    ...
		    <li role="presentation" @if($tab_id == 5) class="active" @endif>
		    	<a href="#{{ (isset($articlesDetail[5])) ?  $articlesDetail[5]->slug : "" }}" >
		    		<i class="icon">
		    ...
		    <li role="presentation" @if($tab_id == 6) class="active" @endif>
		    	<a href="#{{ (isset($articlesDetail[6])) ?  $articlesDetail[6]->slug : "" }}" >
	...
	<div class="block-content" style="padding-bottom:50px">
		<div class="tab-content">
			...
			@foreach($tabArr as $tab_id)
			@if(isset($articlesDetail[$tab_id]))
			<div id="{{ $articlesDetail[$tab_id]->slug }}" style="margin-bottom: 30px"></div>
			<div role="tabpanel" class="tab-pane fade in active" id="">
				
				<div class="page-block">
					<h2 class="page-title">{{ $articlesDetail[$tab_id]->title }}</h2>
					<div class="page-content editor-content">
						<?php 
						echo preg_replace('/(\<img[^>]+)(style\=\"[^\"]+\")([^>]+)(>)/', '${1}${3}${4}', $articlesDetail[$tab_id]->content); 
						?>
					</div>
				</div>
